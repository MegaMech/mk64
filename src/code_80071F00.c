...
extern s32 D_8018C5F0;

extern s32 D_8018C830;
...
void func_80075838(void)
{
    ...
    if ((D_801636A0 != 0) || (D_8016578C != 0)) {
        var_s2 = 0;
        for (someIndex = 0; someIndex < 128; someIndex++) {
            objectIndex = D_8018C3F0[someIndex];
            if (objectIndex != -1) {
                temp_s0 = &D_80165C18[objectIndex];
                if (temp_s0->unk_0A6 != 0) {
                    func_80075714(objectIndex);
                    if (temp_s0->unk_0A6 == 0) {
                        func_80072100(&D_8018C3F0[someIndex]);
                    }
                    var_s2 += 1;
                }
            }
...
void func_80075CA8(void) {
    ...
    if ((D_801637E8 != 0) || (D_8016578C != 0)) {
        var_s2 = 0;
        for (var_s1 = 0; var_s1 < 128; var_s1++) {
            objectIndex = D_8018C3F0[var_s1];
            if (objectIndex != -1) {
                temp_s0 = &D_80165C18[objectIndex];
                if (temp_s0->unk_0A6 != 0) {
                    func_80075B84(objectIndex);
                    if (temp_s0->unk_0A6 == 0) {
        ...
        for (var_s1 = 0; var_s1 < 128; var_s1++) {
            ...
            if (objectIndex != -1) {
                ...
                if (temp_s0->unk_0A6 != 0) {
                    func_80075B84(objectIndex);
                    if (temp_s0->unk_0A6 == 0) {
                        func_80072100(&D_8018C630[var_s1]);
                    }
                    var_s2 += 1;
                }
            }
...
void func_800789AC(s32 arg0, Camera *arg1, u16 arg2[][4]) {
    s32 objectIndex;
    s32 i;
    for (i = 0; i < D_8018D1F0; i++) {
        objectIndex = D_8018CC80[arg0 + i];
        func_800788F8(objectIndex, *(u16 *) (arg2 + i), arg1);
    }
}
...
s32 func_8007B040(s32 objectIndex, s32 playerId) {
    ...
    if (gModeSelection == GRAND_PRIX) {
        if (random_int(100) < 0x51) {
            //temp_v0 = playerId * 4;
            var_v1 = func_8007AF40((s16) gLapCountByPlayerId[playerId], (s16) gGPCurrentRaceRankByPlayerId[playerId]);
        } else {
            sp60 = 0;
            func_800C9060((u8)playerId, 0x1900A058U);
            var_v1 = (u8) sp60;
        }
        var_t3 = 1;
        ...
        //if (gPlayerCountSelection1 > 0) {
            ...
            //do {
                if (var_v1_2 != playerId) {
                    ...
                    if (temp_a1 != 0) {
                        sp50[var_a3].unk = var_v1_2;
                        sp40[var_a3].unk = (s32) temp_a1;
                        var_a3 += 1;
                    }
                }
                //var_v1_2 += 1;
                var_a0++;
            } //while (var_v1_2 < gPlayerCountSelection1);
        //}
        if (var_a3 != 0) {
            temp_v0_2 = random_int(var_a3);
            temp_v1 = (&sp50)[temp_v0_2];
            temp_t0_2 = sp40[temp_v0_2].unk2;
...
void func_8007B254(s32 objectIndex, u8 arg1)
{
    s8 temp_v1;
    func_80072428(objectIndex);
    D_80165C18[objectIndex].unk_0A6 = 2;
    D_80165C18[objectIndex].unk_0A4 = 0;
    D_80165C18[objectIndex].unk_068 = gTLUTItemWindowNone;
    D_80165C18[objectIndex].unk_06C = gTextureItemWindowNone;
    D_80165C18[objectIndex].unk_0D9 = 0x28;
    D_80165C18[objectIndex].unk_0DA = 0x20;
    D_80165C18[objectIndex].unk_04C = 0x00000032;
    D_80165C18[objectIndex].unk_0D6 = 1;
    ...
    if (D_80165888 != 0) {
        ...
        D_80165C18[objectIndex].unk_0D6 = 2;
        D_80165C18[objectIndex].unk_0A4 = 0x000E;
        temp_v1 = (s8) D_80165C18[objectIndex].unk_0A4;
        D_80165C18[objectIndex].unk_0D2 = temp_v1;
        D_80165C18[objectIndex].unk_0A2 = temp_v1;
        D_8018CAB8 = 0;
        D_80165888 = 0;
        return;
    }
