        ...
        case 4:
            ...
            if (parent->unk_08 > 0.0f) {
                if (parent->shellIndices[0] > 0.0f) {
                     ...
                     * until the shell is in-front of the player. This allows the shell to always shoot in a foward
                     * direction instead of straying sideways. when fired at the wrong time
                     */
